...
## Environments
- Preview: https://main--test-boiler--msagolj.aem.page/
- Live: https://main--test-boiler--msagolj.aem.live/
...
1. Open the `test-boiler` directory in your favorite IDE and start coding :)
